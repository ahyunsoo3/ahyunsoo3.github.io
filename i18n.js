...
(() => {
  ...
  const KO = {
    ...
    "Monorepo designed for scale": "확장성을 고려한 모노레포 설계",
  ...
  const META = {
    index: {
      en: {
        ...
        description: "From planning through backend design, AI engine build, and live operations for the AI English learning platform 'Missroot TOEFL', I personally led the full lifecycle and drove the product from inception through growth.",
        ogTitle: "Hyunsoo Lee · Technical PM & Solo Founder",
        ogDescription: "From planning through backend design, AI engine build, and live operations for 'Missroot TOEFL', I personally led the full lifecycle and drove the product from inception through growth.",
      },
      ko: {
