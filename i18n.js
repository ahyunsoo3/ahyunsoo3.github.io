/* i18n.js — unified EN/KR translation for all pages
 * Replaces language.js (index/spec) and project-lang.js (project/ai/growth).
 * Technique: TreeWalker collects text nodes whose normalized content matches a
 * key in KO; on language switch, nodeValue is swapped in-place.
 */
(() => {
  /* ── Korean translation dictionary ────────────────────────────────────── */
  const KO = {
    /* ─ Header tabs (intentionally kept in English in KR mode) ─ */
    "About":      "About",
    "Build":      "Build",
    "AI Engine":  "AI Engine",
    "Marketing":  "Marketing",
    ...
    "A real app used by students to prepare for the TOEFL iBT exam.":
      "학생들이 TOEFL iBT 시험 준비에 사용하는 앱입니다.",
    "View full technical deep-dive":
      "전체 기술 상세 보기",

    /* ─ Index · Architecture cards ─ */
    ...
    /* ─ Index · Stack ─ */
    "Technologies": "기술 스택",
    "Full product stack": "풀스택 제품 경험",
    "Mobile client, backend, AI pipeline, billing, and cloud infra — all in production.":
      "모바일, 백엔드, AI 파이프라인, 결제, 클라우드 인프라 — 모두 프로덕션 환경에서 운영 중입니다.",
    "Mobile": "모바일",
    "Backend": "백엔드",
    "AI & Data": "인공지능 & 데이터",
    "ML & Research": "머신러닝 & 연구",
    ...
    /* ─ Index · Workflow ─ */
    "How I work": "저의 작업 방식",
    "End-to-end product work.": "엔드투엔드 제품 작업.",
    "From user problem to shipped update, I design, build, test, release, and maintain across mobile, backend, and ops.":
      "사용자 문제 정의부터 업데이트 출시까지, 모바일, 백엔드, 운영 전반을 설계, 구현, 테스트, 배포, 유지보수합니다.",
    ...
    /* ─ Index · Resume / Background ─ */
    "Background": "배경",
    "Experience highlights": "주요 경력",
    ...
    /* ─ Index · Pitch / Contact / Footer ─ */
    "What I am looking for": "제가 찾는 역할",
    "A senior role focused on shipping real products.": "실제 제품 출시에 집중할 수 있는 시니어 역할.",
    ...
    "Personal essays and longer-form writing — on whatever I'm thinking about.":
      "개인적인 에세이와 긴 글들. 여러 주제에 대해 쓰는 공간입니다.",
  ...
  const META = {
    index: {
      en: {
        ...
        description: "Led Missroot TOEFL from planning through backend, AI, and live ops — solo full-stack work on mobile, backend, and AI pipelines.",
        ogTitle: "Hyunsoo Lee · Technical PM & Solo Founder",
        ogDescription: "Led Missroot TOEFL from planning through backend, AI, and live ops — solo full-stack work on mobile, backend, and AI pipelines.",
      },
      ko: {
        title: "이현수 · 테크니컬 PM & 1인 창업자",
        description: "AI 영어 학습 플랫폼 'Missroot TOEFL'의 기획부터 백엔드 설계, AI 엔진 구축, 서비스 운영에 이르는 전 생애주기를 직접 주도하며 제품의 탄생과 성장을 이끌었습니다.",
        ogTitle: "이현수 · 테크니컬 PM & 1인 창업자",
        ogDescription: "Missroot TOEFL의 기획부터 백엔드 설계, AI 엔진 구축, 서비스 운영까지 전 생애주기를 직접 주도했습니다.",
      },
    },
    project: {
      en: {
    ...
    blog: {
      en: {
        ...
        description: "Personal essays and writing by Hyunsoo Lee — on whatever I'm thinking about.",
      },
      ko: {
        title: "블로그 · 이현수",
        description: "이현수의 개인 에세이와 글 — 여러 주제에 대해 쓰는 공간.",
      },
    },
  };
    ...
    const walker = document.createTreeWalker(
      ...
      NodeFilter.SHOW_TEXT,
      {
        acceptNode(node) {
          ...
          if (["SCRIPT", "STYLE", "SVG", "META", "LINK"].includes(p.tagName))
  ...
  function updateMeta(lang) {
    ...
    const m = (META[pageKey] || META.project)[lang];
